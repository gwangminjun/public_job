      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-8 w-full">
        ...
        {bookmarks.length === 0 ? (
          <div className="text-center py-20 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 transition-colors duration-300">
            ...
            <p className="text-lg font-medium text-gray-900 dark:text-white">{t('bookmarks.emptyTitle')}</p>
            <p className="text-gray-500 dark:text-gray-400 mt-2">{t('bookmarks.emptyDesc')}</p>
          </div>
        ) : (
          <JobList 
            jobs={bookmarks} 
